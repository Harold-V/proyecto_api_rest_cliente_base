...
public class UsuarioRepository {
	...
	private void cargarClientes() {
		...
		ClienteEntity objCliente2 = new ClienteEntity(2, "321456", "Catalina", "Lopez", "catalina@unicauca.edu.co",
				new Date());
		this.listaDeClientes.add(objCliente2);

		ClienteEntity objCliente3 = new ClienteEntity(3, "789456", "Sandra", "Sanchez", "Sandra@unicauca.edu.co",
				new Date());
		this.listaDeClientes.add(objCliente3);

		ClienteEntity objCliente4 = new ClienteEntity(4, "133456", "Andres", "Perez", "andres@unicauca.edu.co",
				new Date());
